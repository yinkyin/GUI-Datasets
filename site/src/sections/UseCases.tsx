    ...
    <section id="roadmap" className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
      <div className="rounded-4xl border border-border bg-card p-6 shadow-soft lg:p-8">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-bold uppercase tracking-[0.18em] text-accent">Research paths</p>
            <h2 className="font-display text-3xl font-bold text-foreground">Recommended combinations by use case</h2>
          </div>
        </div>
